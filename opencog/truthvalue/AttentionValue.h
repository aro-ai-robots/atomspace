...
public:
	...
	static const osti_t DEFAULTATOMOSTI;
...
public:
    ...
    static AttentionValuePtr createAV(sti_t s = DEFAULTATOMSTI,
									  ...
									  osti_t o = DEFAULTATOMOSTI)
    {
        return std::make_shared<const AttentionValue>(s, l, v, o);
    }
